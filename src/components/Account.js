...
const Account = () => {
  ...
  // Sleep schedule functionality has been moved to the Study Suggestions page
  

  
  // Sleep schedule state is kept for compatibility with the API
  // but the UI has been moved to the Study Suggestions page
